...
const MELODY_B: [number, number][] = [
  // 마디 1 — Am, 리드 훅
  [659.25,0.5],[880.00,0.5],[783.99,0.5],[659.25,0.5],[523.25,0.5],[659.25,0.5],[440.00,0.5],[523.25,0.5],
  // 마디 2 — Am, 확장
  [880.00,1],[783.99,0.5],[659.25,0.5],[523.25,1],[440.00,1],
  // 마디 3 — F, 전환
  [698.46,0.5],[880.00,0.5],[1046.50,0.5],[880.00,0.5],[698.46,0.5],[523.25,0.5],[440.00,0.5],[349.23,0.5],
  // 마디 4 — F, 롱노트
  [880.00,1],[698.46,1],[523.25,0.5],[440.00,0.5],[349.23,1],
  // 마디 5 — C, 밝은 전환
  [783.99,0.5],[659.25,0.5],[523.25,0.5],[659.25,0.5],[783.99,0.5],[1046.50,0.5],[659.25,0.5],[523.25,0.5],
  // 마디 6 — C, 그루브
  [659.25,1],[783.99,1],[880.00,0.5],[783.99,0.5],[659.25,1],
  // 마디 7 — G, 빌드
  [587.33,0.5],[783.99,0.5],[987.77,0.5],[783.99,0.5],[587.33,0.5],[783.99,0.5],[493.88,0.5],[587.33,0.5],
  // 마디 8 — 루프 접합 (Am 해결)
  [783.99,0.5],[659.25,0.5],[523.25,0.5],[440.00,0.5],[659.25,1],[440.00,1],
];
const BASS_B: [number, number][] = [
  [110.00,2],[82.41,2],  [110.00,2],[82.41,2],  // Am
  [87.31,2], [130.81,2], [87.31,2], [130.81,2], // F
  [130.81,2],[98.00,2],  [130.81,2],[98.00,2],  // C
  [98.00,2], [146.83,2], [98.00,2], [110.00,2], // G→Am
];
const PADS_B: [number, number, number][] = [
  [220.00,261.63,329.63],[220.00,261.63,329.63], // Am
  [174.61,220.00,261.63],[174.61,220.00,261.63], // F
  [261.63,329.63,392.00],[261.63,329.63,392.00], // C
